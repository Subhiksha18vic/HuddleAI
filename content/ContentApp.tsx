...
export default function ContentApp() {
  ...
  async function initSmith() {
    ...
    alert(
      `Smith is ready to help you with the meeting. Please click on the chat button to start the conversation. ${currentRoom}`
    );
          ...
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl lg:rounded-3xl md:pt-24 md:h-full sm:h-[100vh] lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            <div className="mx-auto max-w-md text-center lg:py-12 lg:mx-0 lg:flex-auto lg:text-left">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Smith is a conversational AI assistant that helps you with your meetings, and notes for your meetings.
                It also acts as a second brain to help you take notes faster.
              </p>
              {!chatActive ? (
                <button
                  onClick={initSmith}
